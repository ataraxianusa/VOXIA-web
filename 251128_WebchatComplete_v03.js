...
// Version: 251128_WebchatComplete_v03.js
// Last Updated: 2025-11-28
// Description: Complete webchat implementation from index.html
...
Chatbot.init({
    ...
    theme: {
        button: {
            ...
            dragAndDrop: true,
            iconColor: "white",
            customIconSrc: "https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg",
            autoWindowOpen: {
        ...
        disclaimer: {
            title: "Disclaimer",
            message: "Dengan menggunakan chatbot ini, Anda menyetujui <a target='_blank' href='https://voxia.id/privacy-policy.html'>Syarat & Ketentuan</a>",
            textColor: "black",
            buttonColor: "#3b82f6",
