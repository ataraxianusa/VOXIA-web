    ...
    useEffect(() => {
        try {
            ...
            const newChat = ai.chats.create({
                ...
                config: {
                    systemInstruction: "You are a helpful and friendly AI assistant for VOXIA, a Customer Service & CRM Platform for Indonesian SMEs. Your role is to answer user questions about VOXIA's features, solutions, pricing, and benefits. Keep your answers concise, informative, and maintain a positive tone. The landing page content is your primary source of information.",
                },
            });
            setChat(newChat);
            setMessages([
